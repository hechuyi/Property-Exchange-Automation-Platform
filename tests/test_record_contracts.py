...
class RecordContractsTest(unittest.TestCase):
    ...
    def test_canonical_record_is_frozen_and_serializes_core_fields(self) -> None:
        ...
        self.assertEqual(payload["business_identity"]["record_family"], "listing")
        self.assertEqual(payload["business_identity"]["business_type"], "equity_transfer")

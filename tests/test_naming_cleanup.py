...
class NamingCleanupTest(unittest.TestCase):
    def test_retired_entrypoints_and_packages_are_removed(self) -> None:
        retired_paths = [
            ...
            REPO_ROOT / "Reference",
            REPO_ROOT / "docs" / "desktop_electron_smoke_report_2026-03-28.md",
            REPO_ROOT / "docs" / "desktop_product_delivery_report_2026-03-26.md",
            REPO_ROOT / "docs" / "desktop_product_release_blockers_2026-03-26.md",
            REPO_ROOT / "docs" / "frontend_redesign_real_validation_2026-04-10.md",
            REPO_ROOT / "docs" / "frontend_redesign_test_matrix_2026-04-09.md",
            REPO_ROOT / "docs" / "native_file_picker_smoke_2026-04-18.md",
            REPO_ROOT / "docs" / "parser_rule_risk_report.md",
            REPO_ROOT / "docs" / "application_documentation.md",
            REPO_ROOT / "docs" / "frontend_redesign_operator_manual_2026-04-09.md",
            REPO_ROOT / "docs" / "superpowers",
            REPO_ROOT / "docs" / "architecture",
            REPO_ROOT / "docs" / "backend" / "api-contracts.md",
            REPO_ROOT / "docs" / "backend",
            REPO_ROOT / "docs" / "history" / "real_operation_test_report_2026-03-23.md",
            REPO_ROOT / "docs" / "operations",
            REPO_ROOT / "docs" / "plans",
            REPO_ROOT / "docs" / "postprocess",
            REPO_ROOT / "app_v2",
            REPO_ROOT / "parsers",

...
TERMINAL_FAILED_RECORD_STATES = (
    RecordState.PARSED_FAILED.value,
    RecordState.POSTPROCESS_FAILED.value,
)

EXPORT_BLOCKING_RECORD_STATES = (
    RecordState.FIELD_MISSING.value,
    RecordState.PENDING_MAPPING.value,
    RecordState.MAPPING_CONFLICT.value,
    RecordState.CONFLICT.value,
...
EXPORT_ELIGIBLE_RECORD_STATES = (
    RecordState.READY.value,
)

BROWSABLE_RECORD_STATES = (
    *CANONICAL_RECORD_STATES,
    *TERMINAL_FAILED_RECORD_STATES,
)

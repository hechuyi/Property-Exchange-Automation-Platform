...
def download_result_to_summary_payload(
    ...
    *,
    ...
    archive_audit = getattr(result, "archive_audit", None)
    if isinstance(archive_audit, dict) and archive_audit:
        payload["archive_audit"] = _serialize_task_summary_value(archive_audit)

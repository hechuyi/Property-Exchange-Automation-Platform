"""Legacy parser-to-workbook helper for explicit programmatic compatibility use.

It is intentionally not reachable from the public ``peap.cli`` command surface.
Product ingestion and export run through the streaming canonical pipeline.
"""
...
def default_parser_html_root(config_obj: object) -> str:
    ...
    This function must remain consistent with _resolve_archive_root in streaming_daily_pipeline.py.
    ...
    3. DATA_ROOT/outputs/submission (same fallback as the streaming pipeline)
    """

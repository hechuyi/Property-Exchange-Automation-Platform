...
from peap_core import Diagnostic, PageParseResult, SourceMatch


@dataclass
class ParserContext:
    source_file: str = ""
    allow_unknown_deal_business_type: bool = False

...
def _decode_with_candidates(payload: bytes, encodings: Sequence[str | None]) -> str:
    seen: set[str] = set()
...
def _decode_part_payload(part: Message) -> str:
    ...
    return _decode_with_candidates(payload, [part.get_content_charset(), "utf-8", "gb18030"])
...
def _decode_text_content(raw_content: str | bytes) -> str:
    if isinstance(raw_content, str):
        return raw_content
    return _decode_with_candidates(raw_content, ["utf-8", "gb18030"])
